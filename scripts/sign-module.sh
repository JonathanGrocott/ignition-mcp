...
ALIAS="${MODULE_SIGNING_ALIAS:-ignition-mcp-self-signed}"
PASSWORD="${MODULE_SIGNING_PASSWORD:-ignition-mcp}"
MODULE_IN="${MODULE_IN:-$REPO_ROOT/build/ignition-mcp.unsigned.modl}"
MODULE_OUT="${MODULE_OUT:-$REPO_ROOT/build/ignition-mcp.modl}"
